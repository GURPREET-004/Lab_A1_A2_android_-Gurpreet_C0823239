...
/*
    public static final String SQL_CREATE = "CREATE TABLE " + Entry.TABLE_NAME + " (" + Entry.COLUMN_NAME_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT," + Entry.COLUMN_NAME_NAME + " TEXT," + Entry.COLUMN_NAME_EMAIL
            + " TEXT," + Entry.COLUMN_NAME_PASSWORD + " TEXT);";
    public static final String SQL_DELETE = "DROP TABLE IF EXISTS "+ Entry.TABLE_NAME;*/
